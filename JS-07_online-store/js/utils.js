const data = [
  {
    ...
    images: [
      "./img/products/01_iphone_8_plus.webp",
  ...
  },
  {
    ...
    images: [
      "./img/products/03_Samsung_Universe_9.jpg",
  ...
  },
  {
    ...
    images: [
      "./img/products/05_Huawei_P30.jpg",
  ...
  },
  {
    ...
    images: [
      "./img/products/06_MacBook_Pro_2021.png",
  ...
  },
  {
    ...
    images: [
      "./img/products/07_Samsung_Galaxy_Book.jpg",
  ...
  },
  {
    ...
    images: [
      "./img/products/08_MicrosoftSurfaceLaptop4.jpg",
  ...
  },
  {
    ...
    images: [
      "./img/products/09_InfinixINBOOK.jpg",
  ...
  },
  {
    ...
    images: [
      "./img/products/10_HP_Pavilion_15.jpg",
  ...
  },
  {
    ...
    images: [
      "./img/products/11_perfumeOil.jpg",
  ...
  },
  {
    ...
    images: [
      "./img/products/12_BrownPerfume.jpg",
  ...
  },
  {
    ...
    images: [
      ...
      "https://i.dummyjson.com/data/products/53/1.jpg",
...
export class Products {
      ...
      itemBuyToggle.addEventListener("click", () => {
        ...
        if (!this.purchasedRecently) {
          ...
          localStorage.setItem(
            `purchase`,
            JSON.stringify(this.purchasedRecently)
          );
    ...
    moreElementsButton.addEventListener("click", () => {
      if (this.itemsForShow < data.length - 6) {
        ...
        this.parentElement.removeChild(
          document.querySelector(".products-list-container")
        );
        this.renderProducts(data);
        return;
      }
  ...
  filterByPrice() {
    if (this.currentCategory !== "All") {
      const data = this.products.filter(
        ({ price, category }) =>
          price >= this.currentPrice && category === this.currentCategory
      );
  ...
  filterBySearch() {
    ...
    ).innerHTML = `<b>Value:</b> more than $ 0`;
    const searchValue = document.querySelector(
      ".products-filter-search-input"
    ).value;
    const searchElements = this.products.filter(({ title }) =>
  ...
  getStarsMethod(rating) {
    const fillRating = (isFill) =>
      `<i class="bi bi-star-fill" ${
        isFill ? 'style="color:orange"' : ""
      }"></i>`;
    return new Array(5)
      .fill("")
      .map((item, index) => fillRating(Math.round(rating) > index))
      .join("");
  }
...
export class Cart {
  ...
  renderItems(cart) {
    ...
    this.sortedPurchases.map((purchase) => {
      ...
      shopCardContainer.appendChild(
        this.prepareElement(id, image, title, price, count)
      );
    });
  ...
  add(id) {
    this.sortedPurchases = this.sortedPurchases.map((purchase) => {
      if (purchase.id === id) {
        document.querySelector(`.count-of-${id}`).innerHTML = `${
          purchase.count + 1
        }`;
    ...
    document.querySelector(
      `.shop-cart-total`
    ).innerHTML = `<b>Total: $${this.checkSum()}</b>`;
    this.saveToLocalStorage();
  ...
  clearAll(id) {
    this.sortedPurchases = this.sortedPurchases.filter(
    ...
    document
      ...
      .removeChild(document.querySelector(`.item-id-${id}`));
  ...
  checkSum() {
    const totalPrice = this.sortedPurchases.reduce(
  ...
  prepareElement(id, image, title, price, count) {
    ...
    purchaseRemoveItem.innerHTML =
      'Remove <i class="bi bi-x-circle-fill item-remove-icon"></i>';
  ...
  sortingPurchases() {
    ...
    this.sortedPurchases = purchases.reduce((acc, product) => {
      ...
      acc = acc.map((accPoduct) =>
        accPoduct.id === product.id
          ? { ...accPoduct, count: accPoduct.count + 1 }
          : accPoduct
      );
      return acc;
    }, []);
